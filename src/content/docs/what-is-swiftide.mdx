...
:::note
Our query pipeline is under active development and fully usuable, documentation is still a work in process. In the mean time, please refer to our examples and the api documentation.
:::
